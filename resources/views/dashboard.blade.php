                                ...
                                @forelse($students as $student)
                                    <tr class="transition-colors hover:bg-neutral-50 dark:hover:bg-neutral-800/50">
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            <a href="{{ route('students.edit', $student->id) }}" class="text-blue-600 transition-colors hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">Edit</a>
                                            <span class="mx-1 text-neutral-400">|</span>
                                            <form action="{{ route('students.destroy', $student->id) }}" method="POST" style="display:inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="text-red-600 transition-colors hover:text-red-700 dark:text-red-400 dark:hover:text-red-300" onclick="return confirm('Are you sure?')">Delete</button>
                                            </form>
                                        </td>
                                    </tr>
                                @empty
                                    <tr class="transition-colors hover:bg-neutral-50 dark:hover:bg-neutral-800/50">
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            <a href="{{ route('students.edit', 2) }}" class="text-blue-600 transition-colors hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">Edit</a>
                                            <span class="mx-1 text-neutral-400">|</span>
                                            <form action="{{ route('students.destroy', 2) }}" method="POST" style="display:inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="text-red-600 transition-colors hover:text-red-700 dark:text-red-400 dark:hover:text-red-300" onclick="return confirm('Are you sure?')">Delete</button>
                                            </form>
                                    ...
                                    <tr class="transition-colors hover:bg-neutral-50 dark:hover:bg-neutral-800/50">
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            <a href="{{ route('students.edit', 3) }}" class="text-blue-600 transition-colors hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">Edit</a>
                                            <span class="mx-1 text-neutral-400">|</span>
                                            <form action="{{ route('students.destroy', 3) }}" method="POST" style="display:inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="text-red-600 transition-colors hover:text-red-700 dark:text-red-400 dark:hover:text-red-300" onclick="return confirm('Are you sure?')">Delete</button>
                                            </form>
